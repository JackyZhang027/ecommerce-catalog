...
import PermissionDialog from './Form';
...
export default function PermissionIndex({ permissions, groups, filters }: Props) {
  ...
  const handleGroupChange = (value: string) => {
    ...
    router.get('/admin/permissions', { ...filters, group: actualValue }, { preserveScroll: true });
  };

  const handleSearchKey = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter') {
      router.get('/admin/permissions', { ...filters, search }, { preserveScroll: true });
    }
  };
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button variant="ghost" size="icon" className="text-destructive hover:text-red-600 cursor-pointer">
