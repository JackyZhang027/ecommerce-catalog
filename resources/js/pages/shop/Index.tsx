  ...
  return (
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-gray-100">
        ...
        <button className="absolute bottom-0 left-0 right-0 bg-gray-900 text-white py-2 translate-y-full 
            group-hover:translate-y-0 transition-transform duration-300 flex items-center justify-center gap-2 cursor-pointer">
...
function CategoryCard({ category }: { category: Category }) {
  return (
    <Link
      ...
      className="group relative h-48 md:h-64 rounded-lg overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300"
    >
      <img
        src={category.image}
        alt={category.name}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 text-white">
        <h3 className="text-xl md:text-2xl font-bold mb-1 group-hover:translate-y-[-4px] transition-transform">
          {category.name}
        </h3>
